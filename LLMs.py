...
@LLMRegistry.register("Qwen3-VL-LoRA")
class Qwen3_VL_LoRA:
    def __new__(cls, model_path: str, args: Any) -> Any:
        if os.environ.get("use_vllm", "True") == "True":
            raise ValueError("Qwen3-VL-LoRA only supports HuggingFace inference. Set --use_vllm False.")
        from models.Qwen3_VL_LoRA.Qwen3_VL_LoRA_hf import Qwen3_VL_LoRA
        return Qwen3_VL_LoRA(model_path, args)
